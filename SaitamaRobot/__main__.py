...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="📮 Update Channel", url="https://t.me/ToonTamilKing"),
    ],
    [
        InlineKeyboardButton(
            text="✨YT Link✨", url="https://youtube.com/channel/UCFZvWvjHunD14Eh4N1g45Hw"),
          


InlineKeyboardButton(
            text="🐱 SUPPORT", url="https://t.me/joinchat/SHYf2ODyY-0zYjQ1"
        ),

    ],
    [
        InlineKeyboardButton(
                    text="🍀Anime Group🍀", url="https://t.me/joinchat/_BJfqhgl4WcwNmE9"
        ),
    ],
]
...
HELP_STRINGS = """
`Hey there! My name is` [Henry]("https://telegra.ph/file/8eba0c0d88c6ead6c6fc5.jpg"). 
...
def gabi_about_callback(update, context):
    ...
    if query.data == "gabi_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Henry*, a powerful group management bot built to help you manage your group easily.
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🚶 I'm *Henry*
                 \nHere is the [Our Anime Group](https://t.me/joinchat/_BJfqhgl4WcwNmE9) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
